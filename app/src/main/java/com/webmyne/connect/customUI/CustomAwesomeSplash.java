 ...
 */
abstract public class CustomAwesomeSplash extends AppCompatActivity {
    ...
    private CustomConfigSplash mConfigSplash;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConfigSplash = new CustomConfigSplash();
        initSplash(mConfigSplash);

        pathOrLogo = CustomValidationUtil.hasPath(mConfigSplash);
        initUI(pathOrLogo);
    ...
    public void startCircularReveal() {
        ...
        //mRlReveal.setBackgroundResource(mConfigSplash.getBackgroundResource());

        mTxtTitle.setTypeface(null, Typeface.BOLD_ITALIC);
    ...
    public abstract void initSplash(CustomConfigSplash configSplash);
